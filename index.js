...
// let allowedOrigins = 'localhost:8080, localhost:1234, https://cfmyflix.herokuapp.com/, http://localhost:1234, https://cfmyflix.netlify.app/';
	...
	(req, res) => {
		Users.find({ Username: req.params.Username })
			.then((user) => {
				if (user) {
					respData = {
            Favorites: user.favorites.Title
          }
          res.status(201).json(respData)
